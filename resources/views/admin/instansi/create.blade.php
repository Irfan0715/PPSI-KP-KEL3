                    ...
                    <form method="POST" action="{{ route('admin.instansi.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nama_instansi" name="nama_instansi" type="text" class="mt-1 block w-full" :value="old('nama_instansi')" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="kontak" name="kontak" type="text" class="mt-1 block w-full" :value="old('kontak')" />
