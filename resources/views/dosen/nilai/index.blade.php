<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Nilai Pembimbing</h2></x-slot>
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            <a href="{{ route('dosen.nilai.create') }}" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white text-sm px-4 py-2 rounded-lg">Input Nilai</a>
                        ...
                        <table class="min-w-full text-sm divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{ $n->nilai_pembimbing }}</td>
                                ...
                                @empty
                                <tr><td class="px-4 py-3 text-gray-500" colspan="6">Belum ada nilai.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
