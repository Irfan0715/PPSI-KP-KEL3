<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Isi Kuesioner</h2>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm border border-gray-200 rounded-xl">
                <div class="p-6">
                    <form method="POST" action="{{ route('mahasiswa.kuesioner.store') }}">
                        @csrf
                        <div class="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <textarea name="isi_kuesioner" rows="5" class="w-full border-gray-300 rounded-md" required>{{ old('isi_kuesioner') }}</textarea>
                            </div>
                        </div>
