<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Input Nilai Lapangan</h2></x-slot>
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm border border-gray-200 rounded-xl">
                <div class="p-6">
                    <form method="POST" action="{{ route('lapangan.nilai.store') }}" class="space-y-4">@csrf
                        <div>
                        ...
                        <div>
                            ...
                            <input name="nilai_lapangan" type="number" step="0.01" class="w-full border-gray-300 rounded-md" />
                        </div>
